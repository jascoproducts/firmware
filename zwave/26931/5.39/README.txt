...
CHANGELOG:
1. If the button is pressed and held for more than 0.5s, then light will turn on/off at the 0.5s mark.
2. If the button is released before the 3s mark, no further operation will be done.
